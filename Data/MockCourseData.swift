...
enum MockCourseData {
    ...
    static let dictionaryWords: [Word] = [
        Word(
            ingush: "Марша",
            pronunciation: "marsha",
            meaning: "hello",
            examples: [
                Phrase(ingush: "Марша, хьо мишта ва?", pronunciation: "marsha, h'o mishta va?", english: "Hello, how are you?")
            ],
            audioFileName: "marsha"
        ),
        Word(
            ingush: "Баркал",
            pronunciation: "barkal",
            meaning: "thank you",
            examples: [
                Phrase(ingush: "Баркал хьуна.", pronunciation: "barkal h'una", english: "Thank you.")
            ],
        ...
        Word(
            ...
            meaning: "father",
            examples: [
                Phrase(ingush: "Со дацара къамаьл ду.", pronunciation: "so datsara qamael du", english: "I am speaking with father.")
            ],
            audioFileName: "da"
        ),
        Word(
            ...
            meaning: "mother",
            examples: [
                Phrase(ingush: "Нана цIагIа я.", pronunciation: "nana ts'ag'a ya", english: "Mother is at home.")
            ],
            audioFileName: "nana"
        ),
        Word(
            ...
            meaning: "one",
            examples: [
                Phrase(ingush: "Цхьа книжка.", pronunciation: "tskha knizhka", english: "One book.")
            ],
            audioFileName: "tskha"
        ),
        Word(
            ...
            meaning: "two",
            examples: [
                Phrase(ingush: "Ши дош.", pronunciation: "shi dosh", english: "Two words.")
            ],
            audioFileName: "shi"
        )
    ]
    ...
    static let lessons: [Lesson] = [
        Lesson(
            title: "Greetings",
            subtitle: "Say hello and answer simply",
            progress: 0.6,
            isLocked: false,
        ...
        Lesson(
            ...
            subtitle: "I, you, we, and they",
            progress: 0.2,
            isLocked: false,
            exercises: pronounExercises
        ),
        Lesson(
            title: "Family",
            subtitle: "Talk about close relatives",
            progress: 0,
            isLocked: false,
        ...
        Lesson(
            ...
            subtitle: "Useful phrases for daily speech",
            progress: 0,
            isLocked: true,
    ...
    private static let greetingExercises: [Exercise] = [
        Exercise(
            kind: .multipleChoiceTranslation,
            prompt: "What does “Марша” mean?",
            options: [
        ...
        Exercise(
            kind: .wordMatching,
            prompt: "Match each greeting with its meaning.",
            correctAnswer: "Марша - Hello"
        ),
        Exercise(
            kind: .listening,
    ...
    private static let pronounExercises: [Exercise] = [
        Exercise(
            kind: .multipleChoiceTranslation,
            prompt: "Choose the Ingush word for “I”.",
            options: [
